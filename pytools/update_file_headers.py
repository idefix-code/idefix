...
# from MALT (Sébastien Valat) repository.
#
# Original licence is same than this project so it can be reused
# without problems.
#
# - https://github.com/memtt/malt/blob/v1.6.3/dev/update_file_headers.py
# - https://github.com/memtt/malt/blob/v1.6.3/dev/update_file_headers.json
#
############################################################
