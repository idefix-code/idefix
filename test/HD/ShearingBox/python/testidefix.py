...
#
# Source file test/HD/ShearingBox/python/testidefix.py
#
...
def rhs(t, y, Omega, q, k0x, k0y, k0z):
    ...
    dvy = (
        -q * Omega * vx * gyy - (2 - q) * Omega * (1 - gyy) * vx - 2 * Omega * vy * gxy
    )
...
y = solve_ivp(
    rhs, [0, 30], [1, 0, 0], args=(1, 1.5, 0, 2.0 * np.pi, 8 * np.pi), dense_output=True
)
