...
#
# Source file test/Planet/PlanetPlanetRK42D/testme.py
#
...
def testMe(test):
    ...
    for ini in inifiles:
        ...
        assert dump_mtime == os.path.getmtime("dump.0001.dmp"), (
            "Dump was overwritten on restart"
        )
        assert vtk_mtime == os.path.getmtime("data.0005.vtk"), (
            "VTK file was overwritten on restart"
        )
