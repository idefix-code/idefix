...
#
# Source file test/Planet/PlanetSpiral2D/python/testidefix.py
#
...
def _integral(
    ...
    *,
    ...
    data = (
        omega(Rmed, info=info) / soundSpeed(Rmed, h0=h0, flaring=flaring, info=info)
    ) * pow(abs(pow(1 - pow(Rmed / Rp, 3 / 2), 2) - 1 / m / m), 1 / 2)
