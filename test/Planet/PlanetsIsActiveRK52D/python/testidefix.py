...
#
# Source file test/Planet/PlanetsIsActiveRK52D/python/testidefix.py
#
...
print(
    "active1[ip1]=%e, active1[ip1-1]=%e" % (active1[i1_active], active1[i1_active - 1])
)
if (
    error_d0 < 5.0e-10
    and error_d1 < 5.0e-10
    and active0[i0_active] == 1.0
    and active1[i1_active] == 1.0
    and active1[i1_active - 1] == 0.0
):
    print("SUCCESS!")
    sys.exit(0)
else:
